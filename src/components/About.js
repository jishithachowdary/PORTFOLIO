            ...
            <Row xs={1} md={2}>
                ...
                <Col className="px-lg-5 mb-2">
                    <div className="px-lg-5 about-text text-justify">
                        ...
                        <p>
                            A Full Stack Developer from Andhra Pradesh.
                            Have experience in developing UI and CRUD APIs, and always open to new directions of programming.
                        </p>
                        <p>
                            ...
                            development. Believe that continuouslearning and belief are the key factors for achieving personal 
                            and professional success.Have the desire to learn and develop something new, as well as adhere to the rule

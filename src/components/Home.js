      ...
      <Container className="h-100 home-container" role="main">
        <Row xs={1} md={2} className="h-100">
          <Col className="my-auto">
            ...
            <Button className="bg-custom-blue font-weight-bold shadow-sm border-0 resume-btn" onClick={() => window.open('https://drive.google.com/file/d/1Y5PXY3cncVpulygvr4RG4Ic-rvhgavgv/view?usp=sharing', '_blank')}>View Resume</Button>
          </Col>
